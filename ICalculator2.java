...
// ASSIGN. 6 === Inheritance Basics Problem 3
...
Each method in Calculator receives an int argument and applies its operation to currentValue and returns the new value of currentValue. So, if currentValue has the value 8 and sub(6) is invoked then currentValue ends up with the value 2 and 2 is returned
...
public class ICalculator2 extends ICalculator {
    ...
    // Constructor
    public ICalculator2() {
        super(); // Call the constructor of the superclass ICalculator
    }

    // Method to negate the current value
    public int negate() {
        currentValue = -currentValue; // Reverse the sign of currentValue
        return currentValue; // Return the new value of currentValue
    }
